...
if __name__ == "__main__":
    ...
    parser.add_argument("epub", type=Path, help="Path to epub file", required=True)
    parser.add_argument("--output", "-o", type=Path, help="Path to output file. If not provided, output will be printed to stdout", required=False)
    ...
    for name, c in zip(chapter_names,chapter_contents):
        ...
        res = llm.run(parts=["Below is a chapter from a story, summarize it in up to 500 words.\n\n" + c])
